#!/usr/bin/env python3
"""
Recuperation des codes promo FlixBus depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/flixbus.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/flixbus.fr"
STORE_NAME = "FlixBus"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour FlixBus depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-flixbus)"
    }
    try:
